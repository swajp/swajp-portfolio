...
const socials = [
  {
    svg: (
      <svg
        ...
        className="lucide lucide-linkedin stroke-gray-500"
      >
  ...
  },
  {
    svg: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-instagram stroke-gray-500"
      >
    ...
    href: "https://www.instagram.com/miirastejskal/",
  },
  {
    svg: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-twitter stroke-gray-500"
      >
